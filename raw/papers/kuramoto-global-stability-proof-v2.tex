...
\item \textbf{Two cited axioms.} The convergence relies on two published results stated as Lean axioms: (a)~nonlinear Landau damping \cite{dietert2017} for $V \to 0$, and (b)~OA manifold attractivity \cite{dietert-fernandez2018} for the PDE-to-OA bridge. Formalizing these spectral theory results remains future work.
