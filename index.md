...
_Last regenerated: 2026-04-27 (session 8, experiment 21)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: Gronwall chain, unified rate, LorentzianContinuousSolution.tendsto, lorentzian_ode_continuous_convergence (0-assumption continuous-time r(t)→r*). 3335 build jobs.
