...
_Last regenerated: 2026-04-27 (session 8, experiment 22)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: Gronwall chain, tendsto (continuous+discrete), ode_continuous_convergence, tendsto_nat (0-assumption Filter.Tendsto for ℕ). 3335 build jobs.
