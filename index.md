...
_Last regenerated: 2026-04-28 (session 8)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence proves global ODE existence via explicit Bernoulli formula. 3434 build jobs.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 119 files. Four bridge constructions: NPoleContinuumBridge, FullChainContinuumBridge (Path A + SelfContained), LorentzianContinuumBridge instantiate all ContinuumGlobalStability paths.
