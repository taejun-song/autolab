...
_Last regenerated: 2026-05-03 (session 9, experiment 162)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: **100 theorems** (milestone). Primary metric SOLVED. Abstract ODE chain: 31 theorems including billboard. 3336 build jobs.
