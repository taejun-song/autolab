...
- [[lean-proof-status]] — Machine-checked proof status: 116 files, 0 sorry, 0 assumed fields. Unified trifurcation (lorentzian_continuous_trifurcation): any K>0, r(0)∈(0,1) → ∃r_∞, r(t)→r_∞; K≤2γ→r_∞=0, K>2γ→r_∞∈(0,1). 3333 build jobs.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 116 files. Unified trifurcation: lorentzian_continuous_trifurcation covers all K>0 in one Filter.Tendsto statement.
