...
_Last regenerated: 2026-04-27 (session 8, experiment 9)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: explicit Bernoulli rate chain + linearized rate -(K-2γ) at r* confirmed. 3335 build jobs.
