...
_Last regenerated: 2026-04-27 (session 8, experiment 71)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: complete Lyapunov library — V' ODE, exp bounds, distance bounds, convergence times, two-sided trap, interval decay, persistence drop. 3434 build jobs.
