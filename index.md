...
_Last regenerated: 2026-04-27 (session 8, experiment 76)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: complete Lyapunov library — V' ODE, exp bounds, distance bounds (incl. persistence-based), convergence times, trap, interval decay, persistence drop/uniform decay. 3434 build jobs.
