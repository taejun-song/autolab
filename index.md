...
_Last regenerated: 2026-04-27 (session 8, experiment 90)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: complete Lyapunov library + LorentzianContinuousSolution lift (15 theorems: complete two-sided trap, persistence chain, interval/drop, sync). 3434 build jobs.
