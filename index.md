...
_Last regenerated: 2026-05-06 (kuramoto_standard_continuum_solved in GeneralGMainTheorem, exp 250)_

## Recently Updated

- [[continuum-stability-debate]] — GeneralGMainTheorem.lean: `kuramoto_standard_continuum_solved` (0 sorry, 0 axioms) — ORDER PARAMETER SPLITTING for standard continuum model. Body persistence + body L² drop. r-r* = ∫_body(α-α*) + ∫_tail(α-α*) with set-integral Cauchy-Schwarz. Also `kuramoto_continuum_from_body_gronwall` (full chain). ALL g ∈ L¹(R).
