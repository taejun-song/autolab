...
_Last regenerated: 2026-05-06 (kuramoto_ode_standard_continuum in GeneralGMainTheorem, exp 252)_

## Recently Updated

- [[continuum-stability-debate]] — GeneralGMainTheorem.lean: `kuramoto_ode_standard_continuum` (0 sorry, 0 axioms) — ODE-based continuum theorem with explicit OA Riccati data. Resolves all 3 reviewer problems. Body exp decay per M → body drop → tail-body split via `kuramoto_continuum`. ALL g ∈ L¹(R).
