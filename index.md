...
_Last regenerated: 2026-04-27 (session 5)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 116 files, 0 sorry, 0 assumed fields. Complete Lorentzian trifurcation: K < 2γ → r→0, K = 2γ → r→0 (algebraic, new), K > 2γ → r→r*. 3430 build jobs.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 116 files. Complete Lorentzian trifurcation proved: K < 2γ → r→0, K = 2γ → r→0 (algebraic), K > 2γ → r→r*.
