...
_Last regenerated: 2026-04-27 (session 8, experiment 12)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: full Bernoulli chain, linearized rate, local stability 10/r*⁴. 3335 build jobs.
