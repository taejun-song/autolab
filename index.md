...
_Last regenerated: 2026-04-27 (session 8, experiment 102)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: complete Lyapunov library + LorentzianContinuousSolution lift (27 theorems: classical stability, flow structure, invariance, trap, persistence). 3434 build jobs.
