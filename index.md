...
_Last regenerated: 2026-05-06 (kuramoto_standard_model in GeneralGMainTheorem, exp 246)_

## Recently Updated

- [[continuum-stability-debate]] — GeneralGMainTheorem.lean: `kuramoto_standard_model` (0 sorry, 0 axioms) — DEFINITIVE standard continuum theorem. Takes body derivative ISS bound dV_body/dt ≤ -rate(M)·V_body + forcing(M). DERIVES body Gronwall via `gronwall_with_forcing_decay`. No bounded γ, no uniform persistence, no c_min.
