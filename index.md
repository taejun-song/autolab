...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 116 files. Two ODE-derived constructors: nondec (0 assumed) and noninc (1 assumed: persistence).
