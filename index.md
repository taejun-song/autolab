...
_Last regenerated: 2026-04-27 (session 6)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 116 files, 0 sorry, 0 assumed fields. Full trichotomy: lorentzian_convergence_from_ode covers all K>2γ, r(0)∈(0,1) via lt_trichotomy; r(0)=r* case by Gronwall forward uniqueness. 3430 build jobs.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 116 files. Full trichotomy: lorentzian_convergence_from_ode covers K>2γ in one theorem via lt_trichotomy.
