...
_Last regenerated: 2026-04-27 (session 8, experiment 28)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: full ODE analysis, parameter monotonicity, Bernoulli linearization (w_func_diff). 3335 build jobs.
