...
_Last regenerated: 2026-05-03 (session 9, experiment 174)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: **112 theorems** (exp 174: ne_rstar_from_ode abstract ODE backward uniqueness). Primary metric SOLVED. 3373 build jobs.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 120 files. LorentzianExistence: **112 theorems** — Bernoulli + Lyapunov + abstract ODE chain + PL infrastructure. Exp 174: ne_rstar_from_ode (ODE backward uniqueness, NO eq_explicit). 3373 build jobs.
