...
_Last regenerated: 2026-04-27 (session 8, experiment 81)_

## Recently Updated

- [[lean-proof-status]] — Machine-checked proof status: 120 files, 0 sorry. LorentzianExistence: complete Lyapunov library + full LorentzianContinuousSolution lift — persistence v/dist/time/sync, interval decay, drop, uniform decay. 3434 build jobs.
