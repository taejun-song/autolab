...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 52 files. Pair coercivity + continuum exponential rate on locked region.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 52 files. Pair coercivity gives exponential rate on locked region.
