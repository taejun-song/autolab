...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 54 files. Scalar OA convergence + discrete decay with perturbation.
...
- [[lean-proof-status]] — Machine-checked proof status: 0 sorry, 0 axioms across 54 files. Scalar OA convergence + discrete decay.
