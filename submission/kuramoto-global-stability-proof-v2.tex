...
\texttt{r\_stays\_positive + hPsi\_floor} & Scalar dissipative & $\int\gamma\,g < \infty$, $K > K_c$ & $r(t) \to r^*$ & 0 & 0 \\
...
\begin{tabular}{ll}
\textbf{Repository} & \texttt{github.com/taejun-song/kuramoto-lean} \\
