...
Under hypotheses (i), (ii), (iv) of Theorem~\ref{thm:main}, assume additionally that:
\begin{itemize}
\item $\int \gamma\,\mathrm{d}\mu < \infty$ and $\int (1/\gamma)\,\mathrm{d}\mu < \infty$;
\item $K > K_c := 2/\int(1/\gamma)\,\mathrm{d}\mu$ (supercritical coupling);
\item the unique positive equilibrium $(\alpha^*, r^*)$ satisfying~\eqref{eq:equil}--\eqref{eq:sc} exists.
\end{itemize}
