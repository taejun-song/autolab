...
\texttt{full\_kuramoto\_pde\_stability\_via\_axiom} & Conditional bridge & 1 hypothesis + 1 opaque/axiom & $|R_{\mathrm{full}}| \to r_*$ & 0 & 1 \\
\end{tabular}
\end{center}
